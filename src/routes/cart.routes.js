...
const { createCart, getCart, getCartById, updateCartPatch, deleteCart, searchProducts  } = require('../controllers/cart.contoller');
...
router.get('/:userId/products/:productName',);
